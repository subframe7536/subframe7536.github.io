...
### 基本概念
#### 不定积分
在某区间上：$\displaystyle \int f(x)dx=F(x)+C, [F(x)+C]'=f(x)$
...
|                                                                |                                      |
| -------------------------------------------------------------- | ------------------------------------ |
| $\displaystyle\int\sin^2xdx=\dfrac{x}{2}-\dfrac{\sin 2x}{4}+C$ | 方法：$\sin^2x=\dfrac{1-\cos 2x}{2}$ |
| $\displaystyle\int\cos^2xdx=\dfrac{x}{2}+\dfrac{\sin 2x}{4}+C$ | 方法：$\cos^2x=\dfrac{1+\cos 2x}{2}$ |
| $\displaystyle\int\tan^2xdx=\tan x-x+C$                        | 方法：$\tan^2x=sec^2x-1$               |
| $\displaystyle\int\cot^2xdx=-\cot x-x+C$                       | 方法：$\cot^2x=csc^2x-1$               |
