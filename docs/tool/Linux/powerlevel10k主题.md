...
```
### 字体修改
字体改为 [`concolas-with-YaHei`](https://github.com/crvdgc/Consolas-with-Yahei/blob/master/ttf/Consolas-with-Yahei%20Nerd%20Font.ttf) 或者`FiraCode NF`或者`InconsolataLGC NF`
### 配置修改
```shell
# Generated by Powerlevel10k configuration wizard on 2021-09-25 at 11:34 CST.
...
# blurred tails, 2 lines, solid, no frame, light-ornaments, sparse, concise,
...
() {
  ...
  typeset -g POWERLEVEL9K_VCS_BRANCH_ICON='ψ '
  ...
  ###########[ ip: ip address and bandwidth usage for a specified network interface ]###########
  # IP color.
  typeset -g POWERLEVEL9K_IP_BACKGROUND=12
